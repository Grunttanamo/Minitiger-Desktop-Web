...
echo
echo "[Minitiger Sync] Fertig. Endpoints: /Minitiger/VirtualLibraries/Status · /Minitiger/ImageFix/Status · /Minitiger/TrailerDownload/Status · /Minitiger/TrailerDetection/Detect"
